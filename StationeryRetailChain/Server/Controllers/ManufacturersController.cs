...
namespace StationeryRetailChain.Server.Controllers
{
    ...
    public class ManufacturersController : ControllerBase
    {
        ...
        public ManufacturersController(StationeryRetailChainContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<IEnumerable<Manufacturer>>> GetManufacturers()
        {
          if (_context.Manufacturers == null)
          {
            ...
            return await _context.Manufacturers.Include(e=>e.Country).ToListAsync();
        }
        ...
        public async Task<ActionResult<Manufacturer>> PostManufacturer(Manufacturer manufacturer)
        {
          if (_context.Manufacturers == null)
          {
              return Problem("Entity set 'StationeryRetailChainContext.Manufacturers'  is null.");
          }
